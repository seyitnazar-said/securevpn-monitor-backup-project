...
package="/home/ubuntu/prometheus"
...
# "Install prometheus, change ownership and create a service file"
print_color "green" "move binary files and conf file"
cd "$package"
sudo mv prometheus "$prometheus_bin"
sudo mv promtool "$promtool_bin"
sudo mv prometheus.yml "$prometheus_conf"

print_color "green" "change ownership"
sudo chown prometheus:prometheus "$prometheus_bin"
sudo chown prometheus:prometheus "$promtool_bin"
...
sudo -u prometheus "$promtool_bin" check config "$prometheus_conf"
